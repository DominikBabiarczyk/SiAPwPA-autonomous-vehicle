...
```export GZ_SIM_RESOURCE_PATH=$GZ_SIM_RESOURCE_PATH:/home/developer/ros2_ws/src/models/ackermann-vehicle-gzsim-ros2/saye_description/models```

uruchomienie:
```gz sim -r worlds/Trapezoid/worlds/Trapezoid.world```
